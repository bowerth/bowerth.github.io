...
- [Spark RDD API examples, Zhen He, La Trobe University](http://homepage.cs.latrobe.edu.au/zhe/ZhenHeSparkRDDAPIExamples.html)
...
- [Spark in Action: GitHub Repo](https://github.com/spark-in-action/first-edition)
- [Databricks Apache Spark Publications](https://sparkhub.databricks.com/resources/)

## Certification

- [Developer Certification for Apache Spark](http://www.oreilly.com/data/sparkcert)
