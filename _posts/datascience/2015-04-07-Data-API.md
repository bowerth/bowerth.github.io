...
- [OData Catalog: transformed to markdown]({% post_url datascience/api/2015-07-24-cbs-odata-flows %})
- [Available Tables (PDF)](http://www.cbs.nl/NR/rdonlyres/E50FBCD8-EFFA-4E30-8D9B-DE68FEA89B8C/0/StatlineContentsEnglish.pdf)
- [Available Tables (from PDF)]({% post_url datascience/api/2015-07-09-Opendata-Cbs-Nl %})
