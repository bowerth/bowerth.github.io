...
on `hduser` account
:   `$ cd /opt/hadoop`  
	`$ bin/hadoop fs -mkdir /home/hduser/airline`  
	`$ bin/hdfs dfs -copyFromLocal /home/hduser/tmp/airline/delay /home/hduser/airline/`  
	`$ bin/hdfs dfs -ls /home/hduser/airline/delay`  
	`Found 1 items`  
    `-rw-r--r--   1 hduser hduser  689413344 2017-01-13 23:31 /home/hduser/airline/delay/2008.csv`
