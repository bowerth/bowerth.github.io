...
~~~
ssh -i "ami-ca46b6a5-rstudio.pem" ec2-user@ec2-35-157-243-174.eu-central-1.compute.amazonaws.com
ssh -i "ami-ca46b6a5-rstudio.pem" ec2-user@ec2-52-28-237-74.eu-central-1.compute.amazonaws.com
~~~
...
~~~
curl -sSL https://get.docker.com/ | sudo sh                  # install docker (Ubuntu)
~~~

~~~
sudo yum update -y
sudo yum install -y docker                                   # install docker (Amazon Linux)
sudo usermod -a -G docker ec2-user                           # execute Docker commands without using sudo
sudo service docker start                                         # start the Docker service
sudo docker info                                                  # test run without sudo
~~~
...
~~~
git clone https://bowerth@gitlab.com/bowerth/observatory.git # clone repo (requires gitlab password)
~~~
...
sbt "run-main observatory.ec2 1975-2016 epfl-observatory stations.csv .csv target/temperatures"
sbt "run-main observatory.ec2 1985-2016 epfl-observatory stations.csv .csv target/temperatures"
~~~
