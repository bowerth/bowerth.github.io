...
jekyll3_jobs="\.\/professional\/{\% post_url "

jekyll2_datascience="{\% post_url datascience\/api\/"
jekyll3_datascience="\.\/datascience\/{\% post_url "

jekyll2_personal="\.\/personal\/{\% post_url "
jekyll3_personal="{\% post_url personal\/heritage\/"
